...
function gamma_correction_comp((; data)::PhysicalRef{GammaCorrectionData}, images, local_id::Vec{3,UInt32}, global_id::Vec{3,UInt32})
...
workgroup_size(::Type{GammaCorrection}) = (8, 8, 1)
